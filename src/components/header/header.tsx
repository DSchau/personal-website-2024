...
export function Header({ commits, showCopy = true, copy: customizedCopy, byline: customizedByline, className }: Props) {
  ...
  const copy = customizedCopy ? customizedCopy : (
    <>
      Welcome to my website! I update it... {updateWord} ({frequency}). I like to build things, teams, and products and occasionally <a href="/posts/">blog</a> about those topics. I live in San Francisco, California with my lovely wife and two children.
    </>
  )
