...
export function Header({ commits, showCopy = true, className }: Props) {
  ...
  return (
    <header className={[styles.header, className].filter(Boolean).join(' ')}>
      ...
      {showCopy && <p>Welcome to my website! I update it... {updateWord} ({frequency}). I like to build things, teams, and products and occasionally <a href="/posts/">blog</a> about those topics. I live in San Francisco, CA with my lovely wife and son.</p>}
    </header>
  )
}
